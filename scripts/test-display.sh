...
"$PYTHON_BIN" -c "import spidev" 2>/dev/null && echo "✅ spidev" || echo "❌ spidev - MISSING!"
"$PYTHON_BIN" -c "import gpiozero" 2>/dev/null && echo "✅ gpiozero" || echo "❌ gpiozero - MISSING!"
"$PYTHON_BIN" -c "import RPi.GPIO" 2>/dev/null && echo "✅ RPi.GPIO compatibility module" || echo "❌ RPi.GPIO - MISSING!"
